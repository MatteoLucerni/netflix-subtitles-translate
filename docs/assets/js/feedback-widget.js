(function () {
  const FORM_LINK = "https://forms.gle/DK6xH1bjRLuqNHYQ6";
  const UNINSTALL_LINK = "https://forms.gle/1gM23Cmbu1HW3sXCA";
  ...
  const css = `
    ...
    .fb-widget-popup {
      ...
      background: #fff; border-radius: 14px; box-shadow: 0 8px 30px rgba(0,0,0,.28);
    ...
    .fb-widget-icon.fb-feedback { background: #e0f4ff; }
  ...
  const svgFeedback = '<svg viewBox="0 0 24 24" fill="none" stroke="#0284c7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>';
